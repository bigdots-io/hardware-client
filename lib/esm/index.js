...
let canvas;
if (!options.emulate) {
    matrix = new LedMatrix(Object.assign(Object.assign({}, LedMatrix.defaultMatrixOptions()), { rows: parseInt(options.rows, 10), cols: parseInt(options.cols, 10), chainLength: parseInt(options.chainLength, 10), hardwareMapping: GpioMapping.Regular }), Object.assign(Object.assign({}, LedMatrix.defaultRuntimeOptions()), { gpioSlowdown: 2 }));
    matrix.afterSync((mat, dt, t) => {
        if (options.debug && (updateQueue === null || updateQueue === void 0 ? void 0 : updateQueue.length) > 0) {
