...
matrix.afterSync((mat, dt, t) => {
    ...
    if (pixelUpdates) {
        for (const pixel of pixelUpdates) {
            ...
            (_b = (_a = matrix
                .brightness(parseInt(options.brightness, 10))) === null || _a === void 0 ? void 0 : _a.fgColor(parseInt(pixel.rgba ? RGBAToHexA(pixel.rgba, true) : "000000", 16))) === null || _b === void 0 ? void 0 : _b.setPixel(pixel.x, pixel.y);
        }
    }
