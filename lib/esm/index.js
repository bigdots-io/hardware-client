...
matrix.afterSync((mat, dt, t) => {
    ...
    console.log(performance.measure("measure_shift", "mark_shift_start", "mark_shift_end"));
    ...
    console.log(performance.measure("measure_led_matrix", "mark_led_matrix_start", "mark_led_matrix_end"));
