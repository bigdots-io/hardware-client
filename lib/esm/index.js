...
const matrix = new LedMatrix(Object.assign(Object.assign({}, LedMatrix.defaultMatrixOptions()), { rows: parseInt(options.rows, 10), cols: parseInt(options.cols, 10), chainLength: parseInt(options.chainLength, 10), hardwareMapping: GpioMapping.Regular }), Object.assign(Object.assign({}, LedMatrix.defaultRuntimeOptions()), { gpioSlowdown: 2 }));
let updateQueue = [];
